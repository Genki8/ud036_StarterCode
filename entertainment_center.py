...
def main():
    ...
    # Matrix movie: title,duration, storyline, poster URL, and Trailer
    ...
    # Interstellar movie: title,duration, storyline, poster URL, and Trailer
    ...
    # Dumb and Dumber movie: title,duration, storyline, poster URL, and Trailer
    ...
    # Infinity War movie: title,duration, storyline, poster URL, and Trailer
    ...
    # Equalizer movie: title,duration, storyline, poster URL, and Trailer
    ...
    # Shawshank movie: title,duration, storyline, poster URL, and Trailer
    ...
    # Place instances of Movie in an array
    movies = [rick_roll, dumb_and_dumber, interstellar,
              the_equalizer, shawshank_redemption, the_matrix]

    # Generate and open the movies in a webbrowser using fresh_tomatoes.py
